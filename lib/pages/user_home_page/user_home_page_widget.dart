                          ...
                          children: [
                            Column(
                              ...
                              children: [
                                                    ...
                                                    Expanded(
                                                      child: Padding(
                                                        padding: const EdgeInsets.all(
                                                            14.0),
                                                        child: Text(
                                                          'Welcome, ${containerUsersRow?.displayName}!',
                                                          textAlign:
                                                              TextAlign.start,
                                ...
                                FutureBuilder<List<OnboardCheckRow>>(
                                  future: OnboardCheckTable().querySingleRow(
                                    queryFn: (q) => q.eq(
                                      'user_id',
                                      currentUserUid,
                                    ),
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    final containerOnboardCheckRow =
                                        containerOnboardCheckRowList.isNotEmpty
                                            ? containerOnboardCheckRowList.first
                                            : null;
                                    return Container(
                                      decoration: const BoxDecoration(),
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          if (valueOrDefault<bool>(
                                            containerUsersRow?.hasAdminAccess !=
                                                false,
                                            true,
                                          ))
                                            Expanded(
                                  ...
                                  children: [
                                    Expanded(
                                      ...
                                      child: InkWell(
                                        ...
                                        highlightColor: Colors.transparent,
                                        onTap: () async {
                                          context.pushNamed('deliveries_old');
                                        },
                                        child: Card(
                                          clipBehavior:
                                              Clip.antiAliasWithSaveLayer,
