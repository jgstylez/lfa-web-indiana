...
class LfaSupaSupabaseUser extends BaseAuthUser {
  LfaSupaSupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> lfaSupaSupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = LfaSupaSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
